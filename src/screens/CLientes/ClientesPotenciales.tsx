...
class ClientesPotenciales extends Component<any,Mystate>
{
    ...
    {
        const result:Array<SimpleCliente> = await axios.get<ClienteApiResponse>(MyUrls.apiUrl+'/api/clientesPotenciales').then((item)=>{
    ...
    render()
    {
        ...
        <FAB
            ...
            icon="plus"
            onPress={() => {
                this.props.navigation.push('Nuevo Cliente Potencial');
            }}
  />
    </View>
    }
